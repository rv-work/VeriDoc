      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="flex items-center space-x-2 text-gray-600">
            ...
            <span className="text-lg">Loading Universities...</span>
          </div>
        </div>
      </div>
    );
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Review and Remove university registration </p>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-11 pr-8 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 appearance-none bg-white min-w-[200px]"
                >
